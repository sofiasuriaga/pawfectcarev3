...
class _AddDogFoodComponentWidgetState extends State<AddDogFoodComponentWidget> {
  ...
  void initState() {
    ...
    _model.dogfoodNameTextController ??= TextEditingController();
    _model.dogfoodNameFocusNode ??= FocusNode();
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.dogfoodNameTextController,
                              focusNode: _model.dogfoodNameFocusNode,
                              autofocus: true,
                              ...
                              validator: _model
                                  .dogfoodNameTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                                      ...
                                      builder: (context) => InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          await FeedChartsTable().insert({
                                            'chart_recipe': _model
                                                .dogfoodNameTextController.text,
                                            'chart_dosage': _model
