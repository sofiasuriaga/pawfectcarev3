...
import '/components/terms_and_condition_component/terms_and_condition_component_widget.dart';
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          _model.formvValidation = true;
                                          if (_model.formKey.currentState ==
                                                  null ||
                                              !_model.formKey.currentState!
                                                  .validate()) {
                                            safeSetState(() =>
                                                _model.formvValidation = false);
                                            return;
                                          }
                                          ...
                                          _shouldSetState = true;
                                          if ((_model.apiResult5xc?.succeeded ??
                                              true)) {
                                            _model.apiResultpfk =
                                                await RegisterUserPatchCall
                                                    .call(
